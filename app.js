...
var UIController = (function(){
	...
	return {
		...
		addListItem: function(obj, type){
			...
			// 创建一个item 的HTML 标记的string,其中包含占位符。占位符是为了用真实的数据去替换掉。
			if (type === 'inc') {
		...
		displayMonth: function(){
			...
			months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'Augusts', 'Spetember','October', 'November', 'December'];
			month = now.getMonth();
...
var controller = (function(budgetCrtl, UICtrl){
	...
	return {
		init: function(){
			console.log('Application has stearted!');
			UICtrl.displayMonth();
